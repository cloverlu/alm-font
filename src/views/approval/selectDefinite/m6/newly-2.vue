    ...
    <div class="newly2">
      <div class="coInformation">
        ...
        <mt-field
          type="textarea"
          rows="3"
          v-model="detail.addedOverduesMsg"
          class="textArea"
          style="overflow:hidden"
          :disabled="true"
        ></mt-field>
        ...
        <mt-field
          type="textarea"
          rows="3"
          v-model="detail.shrinkLoanScaleMsg"
          class="textArea"
          style="overflow:hidden"
          :disabled="true"
        ></mt-field>
        ...
        <mt-field
          type="textarea"
          rows="3"
          v-model="detail.addedGuaranteesMsg"
          class="textArea"
          style="overflow:hidden"
          :disabled="true"
        ></mt-field>
