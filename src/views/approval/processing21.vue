...
<template>
  <div class="checkDetail">
    <!--填写信息  -->
    <div class="processing21" ref="processing21">
      <!-- <div class="formTitle">
        <span class="lightBlue"></span>
        <span class="coNameBlack">一级支行/二级分行检查情况</span>
      </div> -->
      <div class="item1">
        <span class="tag1">第二经营主责任人复核意见</span>
        <almSelect
  ...
  methods: {
    ...
    goSign: function() {
      ...
      this.lineCanvas({
        ...
        box: this.$refs.processing21, // 拿到宽度
