  ...
  <div class="checkDetail">
    ...
    <div class="coInformation">
      ...
      <div class="dailyCheck">
        ...
        ></mt-cell>
        <!-- <div class="signBox">
          <span class="left">征信报告查询日期</span>
          <span class="right" @click="changeVisible()">2020-06-01</span>
        </div> -->
      </div>
      ...
      <div class="enterpriseCredit">
        ...
        <mt-field
          ...
          label="未销户贷记卡账户"
          placeholder="10"
          v-model="DetailsOfIOU.DebitCardNum"
        ></mt-field>
        <mt-field
          class="textFiled"
          label="未销户贷记卡担保金额"
          placeholder="10"
          v-model="DetailsOfIOU.DebitCardLineAmout"
        ></mt-field>
